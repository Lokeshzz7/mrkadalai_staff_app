...
import { useOutletDetails } from '../utils/outletUtils'; // 1. IMPORT THE HOOK
...
const Reports = () => {
    ...
    // 2. USE THE HOOK TO GET THE outletId
    ...
    const getOrderTypePieData = () => {
        if (!orderTypeData || typeof orderTypeData.appOrders === 'undefined') return [];
        return [
    ...
    const getCategoryPieData = () => {
        if (!Array.isArray(categoryBreakdownData)) return [];
        const colors = { 'Meals': '#3b82f6', 'Starters': '#10b981', 'Desserts': '#f59e0b', 'Beverages': '#8b5cf6' };
    ...
    const getDeliveryTimeLineData = () => {
        if (!Array.isArray(deliveryTimeData)) return [];
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card title="Sales Trend">
                    ...
                    ) : <div className="text-center py-16 text-gray-500">No sales trend data found for the selected date range</div>}
                </Card>
                ...
                <Card title="Order Type Breakdown">
                    ...
                    ) : <div className="text-center py-16 text-gray-500">No order type data found for the selected date range</div>}
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card title="New Customers Trend">
                    ...
                    ) : <div className="text-center py-16 text-gray-500">No new customers data found for the selected date range</div>}
                </Card>
                ...
                <Card title="Category Wise Breakdown">
                    ...
                    ) : <div className="text-center py-16 text-gray-500">No category breakdown data found for the selected date range</div>}
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card title="Orders by Delivery Time">
                    ...
                    ) : <div className="text-center py-16 text-gray-500">No delivery time data found for the selected date range</div>}
                </Card>
                ...
                <Card title="Cancellations and Refunds">
                    ...
                    ) : <div className="text-center py-16 text-gray-500">No cancellation/refund data found for the selected date range</div>}
                </Card>
            </div>
            ...
            <Card title="Quantity Sold by Dishes">
                {quantitySoldData?.length > 0 ? (
                    <div className="h-96 w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={quantitySoldData} margin={{ top: 20, right: 30, left: 20, bottom: 100 }}>
                                <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                                <XAxis dataKey="productName" tickLine={true} tick={{ fontSize: 12, angle: -45, textAnchor: 'end' }} height={120} interval={0} />
                ...
                ) : <div className="text-center py-16 text-gray-500">No quantity sold data found for the selected date range</div>}
            </Card>
        </div>
    );
};
