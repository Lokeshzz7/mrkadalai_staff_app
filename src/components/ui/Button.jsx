...
const Button = ({
    ...
    const variants = {
        ...
        success: 'bg-[#269441] text-white hover:bg-green-700 focus:ring-green-500 disabled:bg-green-300',

        danger: 'bg-[#FF0606] text-white hover:bg-red-700 focus:ring-red-500 disabled:bg-red-300',
